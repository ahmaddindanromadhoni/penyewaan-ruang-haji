            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Pelunasan</h1>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Pelunasan</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="../laporan/cetak_pelunasan.php" class="btn btn-warning mb-3" target="_blank"><i class="fas fa-print mr-2"></i>Print</a>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-success btn-sm" href="update_pelunasan.php?no_pesan=<?php echo $d['no_pesan'];?>"><i class="fas fa-check-circle"></i></a></td>
                            </tr>
                            <?php
                                }
                            ?> 
