            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Input Ruang</h1>
                    </div>
                  ...
                  <div class="col-lg-8">
                     ...
                     <div class="card card-secondary">
                      <div class="card-header bg-primary">
                        <h3 class="card-title text-white">From input Data Ruang</h3>
                      </div>
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form action="tambah_ruangan.php" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_ruangan" placeholder="Nama Ruang">
                          </div>
                          <div class="form-group">
                            <label for="cont_person">Cont Person</label>
                            <input type="text" class="form-control" name="cont_person"placeholder="Cont Person"></input>
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tlp_person"placeholder="Tlp Person"></input>
                          </div>
                          <div class="form-group">
                            <label for="terif_biasa">Tarif Biasa</label>
                            <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Rp.</span>
                            </div>
                            <input type="text" class="form-control" name="tarif_biasa"placeholder="Tarif Biasa"></input>
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tarif_kerjasama"placeholder="Tarif Kerjasama"></input>
                          </div>
                          <div class="form-group">
                            <label for="fasilitas">Fasilitas</label>
                            <textarea type="text" class="form-control" rows="3" name="fasilitas"placeholder="Fasilitas"></textarea>
                          </div>
                          <div class="form-group">
                            <label for="gambar_ruang">Gambar</label>
                            <input type="file"name="gambar_ruang" required></input>
