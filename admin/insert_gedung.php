            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Input Gedung</h1>
                    </div>
     <!-- Main content -->
          ...
          <div class="col-lg-8">
             ...
             <div class="card card-secondary">
              <div class="card-header bg-primary">
                <h3 class="card-title text-white">From input Data Gedung</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="tambah_gedung.php" enctype="multipart/form-data" class="form-horizontal form-label-left">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="alamat_gedung" placeholder="Alamat Gedung" rows="4" required></textarea>
                  </div>
                  <div class="form-group">
                    <label for="gambar">Gambar</label>
                    <input type="file"name="gambar_gedung" required></input>
