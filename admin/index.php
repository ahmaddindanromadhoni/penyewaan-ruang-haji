            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php 
                        include'../koneksi.php';
                        $tampil = mysqli_query($koneksi, "SELECT * FROM ruangan ORDER BY kd_ruang DESC");
                        $d1 = mysqli_num_rows($tampil);
                         ?>
                        ...
                        <?php 
                        include'../koneksi.php';
                        $tampil = mysqli_query($koneksi, "SELECT * FROM gedung ORDER BY kd_gedung DESC");
                        $d2 = mysqli_num_rows($tampil);
                         ?>
                        <div class="col-xl-3 col-md-6 mb-4">
